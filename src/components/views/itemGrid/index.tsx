...
const ItemgridView = () => {
    ...
    const layout = () => hotelList?.map(item => (
        <div 
            className="col col-auto m-2 fs-6" 
             style={{ 
                 fontFamily: "Poppins",
                 filter: !(item?.can_take_order) ? 'grayscale(80%)' : ''
                }}
        >
            <div className="card p-1" style={{ width: "20rem" }}>
    ...
    return (
        <div className="d-flex w-100 flex-column m-auto justify-content-center">
